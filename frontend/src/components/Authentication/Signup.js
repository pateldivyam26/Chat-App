...
const Signup = (props) => {
    ...
    const postDetails = (pics) => {
        ...
        if (pics.type === "image/jpeg" || pics.type === "image/png") {
            ...
            data.append("cloud_name", "ddnqb3njd");
            fetch("https://api.cloudinary.com/v1_1/ddnqb3njd/image/upload", {
                method: "post",
                body: data,
            })
                .then((res) => res.json())
    ...
    return (
        <VStack spacing="5px">
            ...
            <FormControl id="pic">
                <FormLabel color={boxColor === "black" ? "whatsapp.100" : "black"}>Upload Picture</FormLabel>
                <Input
                    type="file"
                    p={1.5}
                    accept="image/*"
